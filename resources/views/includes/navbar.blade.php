      ...
      <div class="container-fluid" >
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="{{ url('/') }}">
          	<img src="{{ asset('public/img/logo.png') }}" class="logo logo-responsive" />
          	</a>
        </div><!-- navbar-header --> 
        ...
        <div class="navbar-collapse collapse">
        	...
        	<ul class="nav navbar-nav navbar-right">
              ...
              <li  @if(Request::is("home/lapor")) class="active-navbar" @endif>
                <a class="text-uppercase font-default" href="{{ url('home/lapor') }}">Laporkan Masalah</a>
              </li>
