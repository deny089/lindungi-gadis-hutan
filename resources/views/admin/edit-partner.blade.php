      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{ url('panel/admin/partner/update') }}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{ $partner->nama }}" name="nama" class="form-control" placeholder="{{ trans('admin.nama') }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{ $partner->deskripsi }}" name="deskripsi" class="form-control" placeholder="{{ trans('admin.deskripsi') }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
