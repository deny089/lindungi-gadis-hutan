                ...
                <form class="form-horizontal" method="POST" action="{{ url('panel/admin/payments') }}" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
						...
						<!-- edited cacip -->
                      		<option @if( $settings->currency_code == 'RP' ) selected="selected" @endif value="RP">RP</option>
						<!-- end edited cacip -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                         <input type="text" value="{{ $settings->kode_pohon }}" name="kode_pohon" class="form-control" placeholder="Kode yang digunakan untuk pohon">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
				  <!-- end edited cacip -->
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                      	<select name="fee_donation" class="form-control">
						  	...
						  	<option @if( $settings->fee_donation == '10' ) selected="selected" @endif value="15">15%</option>
                          </select>
                      </div>
                    </div>
                  </div><!-- /.box-body -->
