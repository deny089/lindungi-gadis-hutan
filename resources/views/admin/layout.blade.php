          ...
          <ul class="sidebar-menu">
           ...
           <!-- Links -->
            ...
            <li @if(Request::is('panel/admin/categories')) class="active" @endif>
              <a href="{{ url('panel/admin/categories') }}"><i class="fa fa-list-ul"></i> <span>Kategori</span></a>
            </li><!-- ./Links -->
            <!-- Links -->
            <li @if(Request::is('panel/admin/testimoni')) class="active" @endif>
              <a href="{{ url('panel/admin/testimoni') }}"><i class="ion ion-quote"></i> <span>Testimoni</span></a>
            </li><!-- ./Links -->
            <!-- Links -->
            <li @if(Request::is('panel/admin/masalah')) class="active" @endif>
              <a href="{{ url('panel/admin/masalah') }}"><i class="fa fa-file-text"></i> <span>Laporan Masalah</span></a>
            </li><!-- ./Links -->
            <!-- Links -->
            <li @if(Request::is('panel/admin/pohon')) class="active" @endif>
            	<a href="{{ url('panel/admin/pohon') }}"><i class="fa fa-leaf"></i> <span>Pohon</span></a>
            </li><!-- ./Links -->
            <!-- Links -->
            <li @if(Request::is('panel/admin/partner')) class="active" @endif>
              <a href="{{ url('panel/admin/partner') }}"><i class="fa fa-reddit"></i> <span>Partnership</span></a>
            </li><!-- ./Links -->
            <!-- Links -->
            <li @if(Request::is('panel/admin/media')) class="active" @endif>
              <a href="{{ url('panel/admin/media') }}"><i class="fa fa-camera"></i> <span>Media</span></a>
            </li><!-- ./Links -->
            <!-- Links -->
            <li @if(Request::is('panel/admin/nilai')) class="active" @endif>
              <a href="{{ url('panel/admin/nilai') }}"><i class="fa fa-calculator"></i> <span>NilaiHomepage</span></a>
            </li><!-- ./Links -->
            <!-- end edited cacip -->
            ...
            <li @if(Request::is('panel/admin/blog')) class="active" @endif>
              <a href="{{ url('panel/admin/blog') }}"><i class="fa fa-paste"></i> <span>Blogs</span></a>
            </li><!-- ./Links -->
