...
<meta property="og:url" content="{{url("campaign/$campaign->id").'/'.str_slug($campaign->title)}}"/>
<meta property="og:image" content="{{url('public/campaigns/large',$campaign->large_image)}}"/>

<meta property="og:title" content="{{ $campaign->title }}"/>
<meta property="og:description" content="{{ 'Saya telah mendonasikan '.$totalpohon.' Pohon untuk Penghijauan Lindungi Hutan. Mari Lestarikan Hutan Indonesia' }}"/>
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:image" content="{{url('public/campaigns/large',$campaign->large_image)}}" />
<meta name="twitter:title" content="{{ $campaign->title }}" />
<meta name="twitter:description" content="{{ str_limit($campaign->description, 200, '...') }}"/>
...
<div class="col-sm-8">
    <h3 class="btn-block text-left class-montserrat margin-bottom-zero none-overflow" >
        <strong>Total : {{ $settings->currency_symbol.' '.number_format($donasi) }}</strong>
    </h3>
    
    <p>Dengan <b>{{ $donasi / $pohon->harga }}</b> Pohon yang Anda donasikan, Anda berkontribusi mengurangi emisi CO2 sebanyak <b>{{ round($emisi * 1000 , 2) }}</b> gram di hari pertama penanaman nanti pada hari 
    <b>{{ $dina.', '.date('d', strtotime($campaign->tanggal_pelaksanaan)).' '.$wulan.' '.date('Y', strtotime($campaign->tanggal_pelaksanaan)) }}</b>. </p>
...
<div class="panel-group" id="accordion">
  <div class="panel panel-default">
    ...
    <div id="collapse1" class="panel-collapse collapse">
      <div class="panel-body">
            <div class="col-sm-4">
                <p><img src="{{ asset('public/img-transfer/bni.png') }}" style="width: 150px; height: 70px"></p>
            </div>
            <div class="col-sm-8">
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse2" class="panel-collapse collapse">
        <div class="panel-body">
            <div class="col-sm-4">
                <p><img src="{{ asset('public/img-transfer/mandiri.png') }}" style="width: 150px; height: 70px"></p>
            </div>
            <div class="col-sm-8">
                <p>Name : Hario Laskito Ardi</p>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse3" class="panel-collapse collapse">
        <div class="panel-body">
            <div class="col-sm-4">
                <p><img src="{{ asset('public/img-transfer/bca.png') }}" style="width: 150px; height: 70px"></p>
            </div>
            <div class="col-sm-8">
                <p>Name : Hario Laskito Ardi</p>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse4" class="panel-collapse collapse">
        <div class="panel-body">
            <div class="col-sm-4">
                <p><img src="{{ asset('public/img-transfer/doku.png') }}" style="width: 150px; height: 70px"></p>
            </div>
            <div class="col-sm-8">
...
<div class="row margin-bottom-30">
    <div class="col-md-4">
        <a class="btn btn-block btn-facebook" href="https://www.facebook.com/sharer/sharer.php?u={{ url('campaign',$campaign->id).'/'.str_slug($campaign->title) }}" target="_blank"><i class="fa fa-facebook myicon-right"></i> {{trans('misc.share_on')}} Facebook</a>

    </div>
    
    <div class="col-md-4">
        <a class="btn btn-twitter btn-block" href="https://twitter.com/intent/tweet?url={{ url('campaign',$campaign->id) }}&text={{ e( $campaign->title ) }}" data-url="{{ url('campaign',$campaign->id) }}" target="_blank"><i class="fa fa-twitter myicon-right"></i> {{trans('misc.tweet')}}</a>
    </div>
</div>
    <br>
    ...
    <p><strong> 3. Daftarkan akun Anda agar dapat melihat semua hasil kontribusi Anda bersama kami melalu website ini.  </strong></p>
    <br>
    <p>* Ingin bergabung bersama kami dalam kampanye penanaman pohon ini? </p>
    
    @if( Auth::check() )
    <a href="{{url('join/'.$id_user.'/'.$id_campaign)}}" class="btn btn-main btn-lg btn-block custom-rounded" >
    Gabung Aksi
    </a>
    @else
    <a href="{{url('login')}}" class="btn btn-main btn-lg btn-block custom-rounded" >
    Gabung Aksi
    </a>
    @endif
    ...
    <script type="text/javascript"></script>
        <p><strong>Total : {{ $settings->currency_code.' '.number_format($donasi) }}</strong></p>
        <p>Pilih Metode Pembayaran</p>
        <div class="row" >
