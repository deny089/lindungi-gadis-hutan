...
<div class="container margin-bottom-40">
       ...
       <form action="{{ url('account') }}" method="post" name="form">
            ...
            <div class="form-group has-feedback">
              ...
              <input type="text" class="form-control login-field custom-rounded" value="{{ e( $user->telpon ) }}" name="telpon" placeholder="Insert Phone Number" title="Phone Number" autocomplete="off">
             </div><!-- ***** Form Group ***** -->
