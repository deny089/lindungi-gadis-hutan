...
<link rel="stylesheet" type="text/css" href="{{ asset('public/plugins/datepicker/datepicker3.css') }}">
		...
		<div class="filer-input-dragDrop position-relative hoverClass" id="draggable">
			...
			@if($data->cat_id == 1)
                  <div class="form-group">
                      <label>Pilih Pohon untuk ditanam</label>
                      	<select name="id_pohon" class="form-control" value="{{$data->id_pohon}}">
			...
			@if($data->cat_id == 2)
				<div class="form-group">
				    <label>{{ trans('misc.campaign_goal') }}</label>
				    <div class="input-group">
				      <div class="input-group-addon addon-dollar">{{$settings->currency_kode}}</div>
				      <input type="number" min="1" class="form-control" name="goalhewan" id="onlyNumber" value="{{ $data->goalhewan }}" placeholder="10000">
				    </div>
				  </div>
			@endif
				  <!-- edited cacip -->
				  ...
				  <div class="form-group">
				    ...
				    <div class="input-group">
				      <input class="form-control" id="datepicker"  value="{{ date('d-m-Y', strtotime($data->tanggal_pelaksanaan) ) }}" data-date-format="dd-mm-yyyy" name="tanggal_pelaksanaan" placeholder="DD/MM/YYY" type="text"/>
			    	</div>
				  </div>
                  <!-- Start Form Group -->
                    <div class="form-group">
                    ...
                    <!-- youtube -->
                    <div class="form-group">
                      <label>Link embed youtube Hasil Penanaman</label>
