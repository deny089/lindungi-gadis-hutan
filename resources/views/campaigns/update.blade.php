...
<div class="container margin-bottom-40 padding-top-40">
    ...
    <form method="POST" action="" enctype="multipart/form-data" id="formUpdateCampaign">
		...
		<!-- Start Box Body -->
			<div class="form-group">
			  <label>Pohon yang hidup</label>
			  <div class="col-sm-8">
			    <input type="number" name="hidup" class="form-control" placeholder="Jumlah pohon yang masih hidup">&nbsp;&nbsp;&nbsp;
			  </div>pohon
			</div>
		<!-- Start Box Body -->
			<div class="form-group">
			  <label>Pohon yang mati</label>
			  <div class="col-sm-8">
			    <input type="number" name="mati" class="form-control" placeholder="Jumlah pohon yang telah mati">&nbsp;&nbsp;&nbsp;
			  </div>pohon
			</div>
						
		<!-- Start Box Body -->
			<div class="form-group">
			  <label>Tinggi rata-rata pohon</label>
			  <div class="col-sm-8">
			    <input type="text" name="tinggi" class="form-control" placeholder="Tinggi rata-rata dari pohon yang telah ditanam">&nbsp;&nbsp;&nbsp;
			  </div>centimeter
			</div>

			<div class="form-group">
			  <label>Diameter rata-rata pohon</label>
			  <div class="col-sm-8">
			    <input type="text" name="diameter" class="form-control" placeholder="Diameter rata-rata dari pohon yang telah ditanam">&nbsp;&nbsp;&nbsp;
			  </div>centimeter
			</div>


			<div class="form-group">
			  <label>Perkembangan Pohon</label>
			  <div class="col-sm-8">
			    <input type="text" name="perkembangan" class="form-control" placeholder="Perkembangan pohon dari petani">&nbsp;&nbsp;&nbsp;
			  </div>persen
			</div>
		</div><!-- /.box-body -->
