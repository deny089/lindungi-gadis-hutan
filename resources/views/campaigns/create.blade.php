                      	...
                      	<select name="id_pohon" class="form-control">
                      		<option value="">Pilih salah satu pohon</option>
		                      	@foreach(  App\Models\Pohon::orderBy('id_pohon')->get() as $pohon ) 	
		                            <option value="{{$pohon->id_pohon}}">{{ $pohon->nama }}</option>
								@endforeach
                          </select>
                  </div>
				  ...
				  <!-- youtube -->
                    <div class="form-group">
                      <label>Link Embed Youtube</label>
                        <input type="text" value="{{ old('youtube') }}" name="youtube" class="form-control" placeholder="masukan link embeded youtube">
                    </div><!-- /.form-group-->
                  <!-- end edited cacip -->
