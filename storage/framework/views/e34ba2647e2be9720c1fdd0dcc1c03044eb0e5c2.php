          ...
          <ul class="sidebar-menu">
           ...
           <!-- Links -->
            ...
            <li <?php if(Request::is('panel/admin/categories')): ?> class="active" <?php endif; ?>>
              <a href="<?php echo e(url('panel/admin/categories')); ?>"><i class="fa fa-list-ul"></i> <span>Kategori</span></a>
            </li><!-- ./Links -->
            <!-- Links -->
            <li <?php if(Request::is('panel/admin/testimoni')): ?> class="active" <?php endif; ?>>
              <a href="<?php echo e(url('panel/admin/testimoni')); ?>"><i class="ion ion-quote"></i> <span>Testimoni</span></a>
            </li><!-- ./Links -->
            <!-- Links -->
            <li <?php if(Request::is('panel/admin/masalah')): ?> class="active" <?php endif; ?>>
              <a href="<?php echo e(url('panel/admin/masalah')); ?>"><i class="fa fa-file-text"></i> <span>Laporan Masalah</span></a>
            </li><!-- ./Links -->
            <!-- Links -->
            <li <?php if(Request::is('panel/admin/pohon')): ?> class="active" <?php endif; ?>>
            	<a href="<?php echo e(url('panel/admin/pohon')); ?>"><i class="fa fa-leaf"></i> <span>Pohon</span></a>
            </li><!-- ./Links -->
            <!-- Links -->
            <li <?php if(Request::is('panel/admin/partner')): ?> class="active" <?php endif; ?>>
              <a href="<?php echo e(url('panel/admin/partner')); ?>"><i class="fa fa-reddit"></i> <span>Partnership</span></a>
            </li><!-- ./Links -->
            <!-- Links -->
            <li <?php if(Request::is('panel/admin/media')): ?> class="active" <?php endif; ?>>
              <a href="<?php echo e(url('panel/admin/media')); ?>"><i class="fa fa-camera"></i> <span>Media</span></a>
            </li><!-- ./Links -->
            <!-- Links -->
            <li <?php if(Request::is('panel/admin/nilai')): ?> class="active" <?php endif; ?>>
              <a href="<?php echo e(url('panel/admin/nilai')); ?>"><i class="fa fa-calculator"></i> <span>NilaiHomepage</span></a>
            </li><!-- ./Links -->
            <!-- end edited cacip -->
            ...
            <li <?php if(Request::is('panel/admin/blog')): ?> class="active" <?php endif; ?>>
              <a href="<?php echo e(url('panel/admin/blog')); ?>"><i class="fa fa-paste"></i> <span>Blogs</span></a>
            </li><!-- ./Links -->
