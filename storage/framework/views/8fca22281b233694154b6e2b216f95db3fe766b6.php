<!-- Bootstrap core CSS -->
    ...
    <script src="<?php echo e(asset('public/js/ie-emulation-modes-warning.js')); ?>"></script>

    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="<?php echo e(asset('public/js/ie10-viewport-bug-workaround.js')); ?>"></script>
...
<script type="text/javascript">
    ...
    // ReadMore
    var ReadMore = "<?php echo e(trans('misc.view_more')); ?>";
    var ReadLess = "<?php echo e(trans('misc.view_less')); ?>";
