      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="<?php echo e(url('panel/admin/testimoni/add')); ?>" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  ...
                  <div class="box-footer">
                    <a href="<?php echo e(url('panel/admin/testimoni')); ?>" class="btn btn-default"><?php echo e(trans('admin.cancel')); ?></a>
