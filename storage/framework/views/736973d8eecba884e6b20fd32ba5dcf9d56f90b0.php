...
<div class="tab-content">		
		...
		<?php echo App\Helper::checkText($response->description); ?>
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<h3 class="btn-block margin-zero" style="line-height: inherit;">
				<strong class="font-default"><?php echo e($settings->simbol_pohon.number_format($response->donations()->sum('donation'))); ?></strong> 
				<small><?php echo e(trans('misc.of')); ?> <?php echo e($settings->simbol_pohon.number_format($response->goal)); ?> <?php echo e(strtolower(trans('misc.goal'))); ?></small>
				</h3>
