		...
		<?php endif; ?>
        	...
        	<div class="box box-danger">
                ...
                <form class="form-horizontal" method="POST" action="<?php echo e(url('panel/admin/payments')); ?>" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label">price / tree</label>
                      <div class="col-sm-10">
                        <input type="text" value="<?php echo e($settings->hargapohon); ?>" name="hargapohon" class="form-control" placeholder="The price of a tree">
