...
<div class="thumbnail padding-top-zero">
    			...
    			<div class="caption">
    				...
    				<p class="desc-campaigns">
    						<span class="stats-campaigns">
    							<span class="pull-left">
    								<strong><?php echo e($settings->simbol_pohon.number_format($key->donations()->sum('donation'))); ?></strong> 
    				...
    				<h6 class="margin-bottom-zero">
    					<em><strong><?php echo e(trans('misc.goal')); ?> <?php echo e($settings->simbol_pohon.number_format($key->goal)); ?></strong></em>
    				</h6>
