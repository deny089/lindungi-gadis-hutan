    	...
    	<input type="hidden" name="_id" value="<?php echo e($response->id); ?>">
				...
				<div class="form-group">
				    ...
				    <div class="input-group has-success">
				      <div class="input-group-addon addon-dollar"><?php echo e($settings->simbol_pohon); ?>

				      <input type="number"  autocomplete="off" min="<?php echo e($settings->min_donation_amount); ?>" id="onlyNumber" class="form-short input-lg" name="amount" value="<?php echo e(old('donation')); ?>" placeholder="Minimum <?php echo e($settings->min_donation_amount); ?> trees">Trees
				    </div>
				       <div class="input-group-addon addon-dollar"> x <?php echo e($settings->currency_symbol.$settings->hargapohon); ?>  
				       </div>
				     </div>
				  </div>
