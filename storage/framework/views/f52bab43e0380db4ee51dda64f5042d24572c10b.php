...
<?php if( $response->finalized == 0 ): ?>
	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<!-- edited cacip -->
				<strong class="font-default"><?php echo e($settings->kode_pohon.number_format($response->donations()->sum('donation'))); ?></strong> 
				<small><?php echo e(trans('misc.of')); ?> <?php echo e($settings->kode_pohon.number_format($response->goal)); ?> <?php echo e(strtolower(trans('misc.goal'))); ?></small>
				</h3>
			<!-- end edited cacip -->
