<ul class="nav nav-pills nav-stacked">
		  ...
		  <a href="<?php echo e(url('account/donations')); ?>" class="list-group-item <?php if(Request::is('account/donations')): ?>active <?php endif; ?>"> 
		  	...
		  	<li class="margin-bottom-5">
		  		<!-- **** list-group-item **** -->	
		  <a href="<?php echo e(url('account/withdrawals')); ?>" class="list-group-item <?php if(Request::is('account/withdrawals')): ?>active <?php endif; ?>"> 
		  	<i class="fa fa-money myicon-right"></i> <?php echo e(trans('misc.withdrawals')); ?> 
		  	</a> <!-- **** ./ list-group-item **** -->
		  	</li>
