                 ...
                 <!-- Start Box Body -->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="<?php echo e($data->title); ?>" name="title" class="form-control" placeholder="<?php echo e(trans('admin.title')); ?>">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="<?php echo e($data->slug); ?>" name="slug" class="form-control" placeholder="<?php echo e(trans('admin.slug')); ?>">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                      	...
                      	<textarea name="content"rows="5" cols="40" id="content" class="form-control" placeholder="<?php echo e(trans('admin.content')); ?>"><?php echo e($data->content); ?></textarea>
                      </div>
                    </div>
                  </div><!-- /.box-body -->
