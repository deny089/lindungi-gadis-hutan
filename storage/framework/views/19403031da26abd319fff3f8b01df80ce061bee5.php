                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select name="role" class="form-control" >
                      		<option <?php if($data->role == 'normal'): ?> selected="selected" <?php endif; ?> value="normal"><?php echo e(trans('admin.normal')); ?></option>
                          <option <?php if($data->role == 'creator'): ?> selected="selected" <?php endif; ?> value="creator">Creator (Bisa membuat campaign) </option>
