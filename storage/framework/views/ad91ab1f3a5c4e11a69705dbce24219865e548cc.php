		...
		<div class="filer-input-dragDrop position-relative hoverClass" id="draggable">
			...
			<?php if($data->cat_id == 1): ?>
                  <div class="form-group">
                      <label>Pilih Pohon untuk ditanam</label>
                      	<select name="id_pohon" class="form-control" value="<?php echo e($data->id_pohon); ?>">
			...
			<?php if($data->cat_id == 2): ?>
				<div class="form-group">
				    <label><?php echo e(trans('misc.campaign_goal')); ?></label>
				    <div class="input-group">
				      <div class="input-group-addon addon-dollar"><?php echo e($settings->currency_kode); ?></div>
				      <input type="number" min="1" class="form-control" name="goalhewan" id="onlyNumber" value="<?php echo e($data->goalhewan); ?>" placeholder="10000">
				    </div>
				  </div>
			<?php endif; ?>
				  <!-- edited cacip -->
				  ...
				  <div class="form-group">
				    ...
				    <div class="input-group">
				      <input class="form-control" id="datepicker"  value="<?php echo e(date('d-m-Y', strtotime($data->tanggal_pelaksanaan) )); ?>" data-date-format="dd-mm-yyyy" name="tanggal_pelaksanaan" placeholder="DD/MM/YYY" type="text"/>
			    	</div>
				  </div>
                  <!-- Start Form Group -->
                    <div class="form-group">
