                 ...
                 <!-- Start Box Body -->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="<?php echo e($categories->name); ?>" name="name" class="form-control" placeholder="<?php echo e(trans('admin.name')); ?>">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="<?php echo e($categories->slug); ?>" name="slug" class="form-control" placeholder="<?php echo e(trans('admin.slug')); ?>">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
