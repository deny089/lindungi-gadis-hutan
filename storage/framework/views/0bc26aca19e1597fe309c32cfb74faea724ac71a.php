		...
		<?php endif; ?>
        	...
        	<div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo e(trans('admin.limits')); ?></h3>
                </div><!-- /.box-header -->
               
               
               
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="<?php echo e(url('panel/admin/settings/limits')); ?>" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label"><?php echo e(trans('admin.result_request_campaigns')); ?></label>
                      <div class="col-sm-10">
                  ...
                  <div class="box-body">
                    <div class="form-group margin-zero">
                      <label class="col-sm-2 control-label"><?php echo e(trans('admin.file_size_allowed')); ?></label>
                      <div class="col-sm-10">
                          ...
                          <span class="help-block "><?php echo e(trans('admin.upload_max_filesize_info')); ?> <strong><?php echo str_replace('M', 'MB', ini_get('upload_max_filesize')) ?></strong></span>
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label"><?php echo e(trans('admin.min_campaign_amount')); ?></label>
                      <div class="col-sm-10">
                        <input type="number" min="1" autocomplete="off" value="<?php echo e($settings->min_campaign_amount); ?>" name="min_campaign_amount" class="form-control onlyNumber" placeholder="<?php echo e(trans('admin.min_campaign_amount')); ?>">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label"><?php echo e(trans('misc.max_campaign_amount')); ?></label>
                      <div class="col-sm-10">
                        <input type="number" min="1" autocomplete="off" value="<?php echo e($settings->max_campaign_amount); ?>" name="max_campaign_amount" class="form-control onlyNumber" placeholder="<?php echo e(trans('admin.max_campaign_amount')); ?>">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label"><?php echo e(trans('admin.min_donation_amount')); ?></label>
                      <div class="col-sm-10">
                        <input type="number" min="1" autocomplete="off" value="<?php echo e($settings->min_donation_amount); ?>" name="min_donation_amount" class="form-control onlyNumber" placeholder="<?php echo e(trans('admin.min_donation_amount')); ?>">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
