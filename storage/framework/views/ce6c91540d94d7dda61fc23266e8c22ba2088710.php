      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="<?php echo e(url('panel/admin/partner/update')); ?>" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="<?php echo e($partner->nama); ?>" name="nama" class="form-control" placeholder="<?php echo e(trans('admin.nama')); ?>">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="<?php echo e($partner->deskripsi); ?>" name="deskripsi" class="form-control" placeholder="<?php echo e(trans('admin.deskripsi')); ?>">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-footer">
                    <a href="<?php echo e(url('panel/admin/partner')); ?>" class="btn btn-default"><?php echo e(trans('admin.cancel')); ?></a>
