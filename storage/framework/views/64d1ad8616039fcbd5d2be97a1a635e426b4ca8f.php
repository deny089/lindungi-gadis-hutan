...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h4>
           <?php echo e(trans('admin.admin')); ?> <i class="fa fa-angle-right margin-separator"></i> Testimoni
          </h4>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <div class="box-tools">
                    <a href="<?php echo e(url('panel/admin/testimoni/add')); ?>" class="btn btn-sm btn-success no-shadow pull-right">
               ...
               <tbody>
                  ...
                  <?php $__currentLoopData = $testimoni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonis): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <tr>
                      <td><?php echo e($testimonis->id); ?></td>
                      <td><?php echo e($testimonis->nama); ?></td>
                      <td><?php echo e(str_limit($testimonis->testimoni, 100, '...')); ?></td>
                      <td><?php echo e($testimonis->gambar); ?></td>
                      <td>
                      	<a href="<?php echo e(url('panel/admin/testimoni/edit/').'/'.$testimonis->id); ?>" class="btn btn-success btn-xs padding-btn">
                      		<?php echo e(trans('admin.edit')); ?>

                      	</a> 
                      	
                      	<a href="javascript:void(0);" data-url="<?php echo e(url('panel/admin/testimoni/delete/').'/'.$testimonis->id); ?>" class="btn btn-danger btn-xs padding-btn actionDelete">
