...
<div class="col-md-12">	
	...
	<div class="login-form">
		...
		<?php echo $__env->make('errors.errors-forms', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <!-- phone -->
            <div class="form-group has-feedback">
              <input type="text" class="form-control login-field custom-rounded" value="<?php echo e(old('telpon')); ?>" name="telpon" placeholder="Insert Phone Number" title="Phone" autocomplete="off">
              <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <!-- country -->
            <div class="form-group has-feedback">
              <select name="countries_id" class="form-control">
                <option selected="selected"  value="100">Indonesia</option>
                  <?php $__currentLoopData = App\Models\Countries::orderBy('id')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>  
            ...
            <!-- kode area -->
            <div class="form-group has-feedback">
              <input type="text" class="form-control login-field custom-rounded" value="<?php echo e(old('kode_area')); ?>" name="kode_area" placeholder="Postal Code" title="Postal Code" autocomplete="off">
              <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
