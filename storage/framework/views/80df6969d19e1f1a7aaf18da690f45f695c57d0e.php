...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo e(trans('error.error_404')); ?></title>
      ...
      <div class="content-wrapper" style="margin: 0;">
        ...
        <section class="content">
          <div class="error-page text-center">
            ...
            <div class="btn-block">
              <h3><i class="fa fa-warning text-red"></i> <?php echo e(trans('error.error_404_description')); ?></h3>
              <p class="btn-block">
                <?php echo e(trans('error.error_404_subdescription')); ?> 
                
                <p class="btn-block">
                	 <a href="<?php echo e(URL::to('/')); ?>"><?php echo e(trans('error.go_home')); ?></a>
                </p>
