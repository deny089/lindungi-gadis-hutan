...
<div class="navbar navbar-wrapper padding-top-20 padding-bottom-10  margin-bottom-5">
      <div class="container">
      ...
      <div class="container-fluid" >
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
          	<img src="<?php echo e(asset('public/img/logo.png')); ?>" class="logo logo-responsive" />
          	</a>
        </div><!-- navbar-header --> 
        ...
        <div class="navbar-collapse collapse">
        	...
        	<ul class="nav navbar-nav navbar-right">
              ...
              <li  <?php if(Request::is("home/lapor")): ?> class="active-navbar" <?php endif; ?>>
                <a class="text-uppercase font-default" href="<?php echo e(url('home/lapor')); ?>">Laporkan Masalah</a>
              </li>
        			...
        			<li class="dropdown">
	          		...
	          		<!-- edited cacip -->
                <?php if( $userAuth->role == 'admin' || $userAuth->role == 'creator' ): ?>
